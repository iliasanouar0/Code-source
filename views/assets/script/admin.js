...
$(window).on("load", function () {
  ...
  console.log('%c Reporting!!', 'font-weight: bold; font-size: 50px;color: white; text-shadow: 4px 4px 0 rgb(245,221,8),7px 7px 0 blue');
  ...
  console.log('%c The one', 'font-weight: bold; font-size: 20px; color: green; text-shadow:  3px 3px 1px rgb(245,221,8)');
