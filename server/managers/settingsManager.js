...
const getTables = (request, response) => {
    ...
    let sql2 = `SELECT  table_name,  column_name,  data_type  FROM  information_schema.columns WHERE table_name='users' GROUP BY table_name,columns.column_name,columns.data_type`
