...
const getAllProcessSeeds = (request, response) => {
    ...
    let sql = "SELECT process.id_list, seeds.* FROM process JOIN seeds ON seeds.id_list=process.id_list WHERE process.id_process=$1 GROUP BY seeds.id_list,process.id_list,seeds.id_seeds"
