                ...
                case true:
                    ...
                    let options = await page.evaluate(() => {
                        ...
                        for (let i = 0; i < s.length; i++) {
                            if (s[i].offsetWidth == 0 || s[i].href == '' || s[i].href.includes("https://accounts.google.com/") || s[i].target != '_blank') {
...
openInbox(data, 100, { markAsStarted: true, markAsImportant: true, click: true })
